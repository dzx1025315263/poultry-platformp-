...
wb = openpyxl.load_workbook('/home/ubuntu/全球禽肉进口商数据库_全新版.xlsx', read_only=True)

# Build country->continent mapping from regional sheets
country_continent = {}
...
# Read all companies from "全部企业" sheet
ws = wb['全部企业']
companies = []
for row in ws.iter_rows(min_row=2, values_only=True):
